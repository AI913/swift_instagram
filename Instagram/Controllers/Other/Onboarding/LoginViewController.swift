...
class LoginViewController: UIViewController {
        ...
        AuthManager.shared.loginUser(username: username, email: email, password: password) { success in
            DispatchQueue.main.async {
                if success {
                    ...
                    // error occurred
                    let alert = UIAlertController(title: "Log in errror", message: "We were unable to log you in.", preferredStyle: .alert)
    ...
    @objc private func didTapTermButton() {
        guard let url = URL(string: "https://help.instagram.com/477434105621119?helpref=page_content") else {
            return
        }
