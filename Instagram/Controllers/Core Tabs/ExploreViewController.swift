...
extension ExploreViewController: UISearchBarDelegate {
    ...
    @objc private func didCancelSearch() {
        ...
        UIView.animate(withDuration: 0.2, animations: {
            ...
            if done {
                self.dimmedView.isHidden = true  // Even if the alpha became 0, still, the property of dimmedView is better hidden
            }
        }
    }
...
extension ExploreViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let user = User(username: "dennis",
                        bio: "",
                        name: (first: "", last: ""),
                        profilePhoto: URL(string: "https://www.duckduckgo.com")!,
                        birthDate: Date(),
                        gender: .male,
                        counts: UserCount(followers: 1, following: 1, posts: 1), joinDate: Date())
        let post = UserPost(identifier: "",
                            postType: .photo, thumbnailImage: URL(string: "https://duckduckgo.com/")!,
                            postURL: URL(string: "https://www.gab.com/")!,
                            caption: nil,
                            likeCount: [],
                            comments: [],
                            createdDate: Date(),
