...
//  Instagram
//
//  Created by 招耀華 on 19/1/2021.
//

import UIKit

protocol NotificationFollowerEventTableViewCellDelegate: AnyObject {
...
class NotificationFollowEventTableViewCell: UITableViewCell {
    ...
    weak var delegate: NotificationFollowerEventTableViewCellDelegate?
    ...
    private let label: UILabel = {
       let label = UILabel()
        ...
        label.text = "@donaldtrump started following you"
        return label
    }()
